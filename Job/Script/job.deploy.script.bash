...
rsync -rlp -e "ssh -o StrictHostKeyChecking=no -p $SSH_PORT" --delete --exclude-from=./typo3.txt --exclude-from=local-deploy-rsync-excludes.txt .Build/ $SSH_LOGIN:$REMOTE_PATH
